	...
	3. How does the series use evolution to explore its themes? (signified)
		1. HOXPOX
			1. Mutants vs humans-machines
				1. [[Permanent Notes/Red Queen Hypothesis|Red Queen Hypothesis]]
				2. [[Permanent Notes/Evolutionary Arms Race|Evolutionary Arms Race]]
				3. [[Permanent Notes/Transhumanism]]
		2. Planet-Size X-Men
3. Homo sensorium
	1. Sense8's version of mutantdom
	2. How does the series display and hyperbolize evolution? (signifier)
		1. [[Umwelt]] and [[Permanent Notes/Cognition|Cognition]]: shared experience
	3. How does the series use evolution to explore its themes? (signified)
		1. BPO's purpose and the [[Permanent Notes/Competitive Exclusion Principle|Competitive Exclusion Principle]]
4. Comparison
