...
So how can we save our education system from the impacts of information disorder? ==Let us first take some inspiration from the past, where we can see the significance of belief systems in shaping education. (edit later with takeaway from the present?)==
...
- present times
	- What's happening in the Philippines
		- Call for regulation
		- Education
			- Media literacy programs (e.g. FWA?)
			- Truth-fluencers: 
				- academics like Francis Gealogo, journalists like Lian Buan turning to Tiktok
				- Media Commoner disseminating throug graphics
	- Example to follow: How does Finland fight disinformation?
		- Trust
			- Trust is an integral value in Finish culture. "We trust our neighbors, we trust our political opponents, we even trust the taxman. We pay a lot of taxes because we know and trust that we will get a lot in return.”
			- Multi-sectoral approach: government, business, civil society, academia, etc. get together to design the policies and decide the calls to action
		- Education
			- Media literacy incorporated in education: grade schoolers and high schoolers alike spend time comb through online videos and posts to practice diffrentiating fact and fiction, along with learning about media bias.
			- Comprehensive and equal education: irrespective of socioeconomic background, every single kid is entitled to the same high-quality education
